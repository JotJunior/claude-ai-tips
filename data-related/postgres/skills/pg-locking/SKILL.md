...
|-----------|----------|---------------|
| **ACCESS EXCLUSIVE** | ALTER TABLE, DROP TABLE, TRUNCATE, REINDEX, VACUUM FULL | All other modes (including ACCESS SHARE) |
...
| **ACCESS SHARE** | SELECT (reads only) | ACCESS EXCLUSIVE |
